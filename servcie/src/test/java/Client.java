...
public class Client {
  ...
  public boolean run() throws IOException, YarnException {
    ...
    appContext.setUnmanagedAM(true);//debug
  ...
  private boolean monitorApplication(ApplicationId appId)
    ...
    while (true) {
      ...
      LOG.info("currentApplicationAttemptId id=" + report.getCurrentApplicationAttemptId()
      ...
      if (report.getYarnApplicationState() == YarnApplicationState.ACCEPTED) {
       ...
       ApplicationMaster applicationMaster =new ApplicationMaster();
        applicationMaster.main(new String[]{"--app_attempt_id", "" + report.getCurrentApplicationAttemptId(), "debug"});
      }
