...
RTSPClient* RTSPClient::createNew(UsageEnvironment& env,
								  ...
								  portNumBits tunnelOverHTTPPortNum) 
{
	return new RTSPClient(env, NULL,verbosityLevel, applicationName, tunnelOverHTTPPortNum);
}
...
Boolean RTSPClient::announceWithPassword(char const* url, char const* sdpDescription,
