...
public class BssapIndexCallingIndex  implements  HBaseIndex{
	...
	public BssapIndexCallingIndex( QueryBase  lqb)
	{
		try
		{
		...
		table = new HTable(conf, "hbase_bssap_cdr_CallingIndex");
	...
	public void FilterReocordsByIndexTable(ResultScanner scanner, int getOnceNumber,
...
//				System.out.println("***************find  rowkey bytes is " + Arrays.toString(rowkey));
				...
				System.arraycopy(rowkey, 4, 		calling_number, 0, 8);
...
//				System.out.println("***************find  start_time bytes is " + BytesToString.Bytes4ToString(start_time));
				...
				findNumber = Bytes.toLong(calling_number, 0, 8);
...
//						System.out.println("############################get one data");
	...
	public byte[] CombineRowKey(byte[][] byteArrays)
	{
		...
		/*		System.arraycopy(mscid, 0, mscCalledNumTime, 0, 4);
				System.arraycopy(calling_number, 0, mscCalledNumTime, 4, 8);
