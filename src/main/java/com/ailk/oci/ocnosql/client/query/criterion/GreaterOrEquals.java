...
public class GreaterOrEquals extends ExpressionBase {


    Comparable value;

    public GreaterOrEquals(String colFamily, String col, Comparable value) {
        super(colFamily,col);
        this.value = value;
    }
    ...
    public Filter trans2filter(){
        return new SingleColumnValueFilter(Bytes.toBytes(colFamily),Bytes.toBytes(col), CompareFilter.CompareOp.GREATER_OR_EQUAL, Bytes.toBytes(String.valueOf(value)));
    }
}
