...
import com.ailk.oci.ocnosql.client.importdata.*;
...
public class ClientSingleColumn implements Client {
	...
	/* (non-Javadoc)
	 * @see com.ailk.oci.ocnosql.client.spi.Client#exportData(java.lang.String, java.util.Map)
	 * 数据导出
	 */
	@Override
	public boolean exportData(String tableName, Map<String, String> param) throws ClientRuntimeException {
        ...
        ociTableRef.setColumns(MapUtils.getString(param, CommonConstants.COLUMNS));
	...
	/* (non-Javadoc)
	 * @see com.ailk.oci.ocnosql.client.spi.Client#importData(java.lang.String, java.util.Map)
	 * @param tableName 表名
	...
	public boolean importData(String tableName, Map<String, String> param) throws ClientRuntimeException {
        ...
        SingleColumnImportTsv singleImportor = new SingleColumnImportTsv();
        boolean loadResult = singleImportor.execute(connection, ociTableRef);
        resultMap = singleImportor.getReturnMap();
		return loadResult;
	}
	...
	public boolean putData(String tableName, String[] record, Map<String, String> param) throws ClientRuntimeException{
		//throw new ClientRuntimeException("unspported method");
        if(putLoad == null){
			putLoad = new PutLoad();
		}
        param.put(CommonConstants.STORAGE_STRATEGY, "singleimporttsv");
