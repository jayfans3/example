...
class PhoenixCSVLoadDirRunner implements Callable<String>{
	...
	public PhoenixCSVLoadDirRunner(String zk, String tableName, String columus,
			String csvPath,CountDownLatch runningThreadNum) {
		super();
		this.zk = zk;
		this.tableName = tableName;
		this.columus = columus;
		this.csvPath = csvPath;
		this.runningThreadNum = runningThreadNum;
	}
	protected void load(String zk,String tableName,String columus,String csvPath) throws Exception {
	...
	public String call() throws Exception {
		...
		try{
			...
			load(zk,tableName,columus,csvPath);
		} catch (Exception e) {
			e.printStackTrace();
