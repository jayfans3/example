...
public class MinorThan extends ExpressionBase {
    Comparable value;

    public MinorThan(String colFamily, String col,Comparable value) {
        super(colFamily,col);
        this.value = value;
    }
    ...
    public Filter trans2filter(){
        return new SingleColumnValueFilter(Bytes.toBytes(colFamily),Bytes.toBytes(col), CompareFilter.CompareOp.LESS, Bytes.toBytes(String.valueOf(value)));
    }
}
