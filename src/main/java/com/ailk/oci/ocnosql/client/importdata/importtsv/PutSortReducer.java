...
public class PutSortReducer extends
        Reducer<ImmutableBytesPairWritable, Put, ImmutableBytesPairWritable, KeyValue> {

    @Override
    protected void reduce(
            ImmutableBytesPairWritable pair,
            java.lang.Iterable<Put> puts,
            Reducer<ImmutableBytesPairWritable, Put,
                    ImmutableBytesPairWritable, KeyValue>.Context context)
