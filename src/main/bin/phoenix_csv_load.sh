...
java -server -Xms10240m -Xmx10240m -XX:MaxPermSize=25600M -XX:-UseGCOverheadLimit -cp $CLASSPATH com.ailk.oci.ocnosql.client.importdata.phoenix.PhoenixCSVLoadUtil $1 $2 $3 $4 $5 $6 $7 $8